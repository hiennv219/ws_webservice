...
return [
    ...
    'class-times/{id}/confirm'                      => 'buoi-hoc/{id}/xac-nhan',
    'helps'                                         => 'tro-giup',
    'helps/{slug}'                                  => 'tro-giup/{slug}',
    'knowledge'                                     => 'kien-thuc',
    'knowledge/articles'                            => 'kien-thuc/bai-viet',
    'knowledge/articles/create'                     => 'kien-thuc/bai-viet/them-moi',
    ...
    'admin/announcements'                           => 'quan-tri/thong-bao',
    'admin/announcements/create'                    => 'quan-tri/thong-bao/them-moi',
    'admin/announcements/{id}'                      => 'quan-tri/thong-bao/{id}',
    'admin/announcements/{id}/edit'                 => 'quan-tri/thong-bao/{id}/chinh-sua',
...
//    'admin/pages/{id}/edit'                         => 'quan-tri/chuyen-trang/{id}/chinh-sua',
    ...
    'admin/article-categories'                      => 'quan-tri/chuyen-muc-bai-viet',
    'admin/article-categories/create'               => 'quan-tri/chuyen-muc-bai-viet/them-moi',
    'admin/article-categories/{id}'                 => 'quan-tri/chuyen-muc-bai-viet/{id}',
    'admin/article-categories/{id}/edit'            => 'quan-tri/chuyen-muc-bai-viet/{id}/chinh-sua',
    'admin/published-articles'                      => 'quan-tri/bai-viet-da-xuat-ban',
    'admin/teacher-articles'                        => 'quan-tri/bai-viet-cua-giao-vien',
    'admin/articles/create'                         => 'quan-tri/bai-viet/them-moi',
    'admin/articles/{id}'                           => 'quan-tri/bai-viet/{id}',
    'admin/articles/{id}/edit'                      => 'quan-tri/bai-viet/{id}/chinh-sua',
...
//    'admin/media-items/{id}/edit'                   => 'quan-tri/nghe-nhin/{id}/chinh-sua',
    'admin/study-levels'                            => 'quan-tri/trinh-do-hoc-vien',
    'admin/study-levels/create'                     => 'quan-tri/trinh-do-hoc-vien/them-moi',
    'admin/study-levels/{id}'                       => 'quan-tri/trinh-do-hoc-vien/{id}',
    'admin/study-levels/{id}/edit'                  => 'quan-tri/trinh-do-hoc-vien/{id}/chinh-sua',
    'admin/study-problems'                          => 'quan-tri/van-de-cua-hoc-vien',
    'admin/study-problems/create'                   => 'quan-tri/van-de-cua-hoc-vien/them-moi',
    'admin/study-problems/{id}'                     => 'quan-tri/van-de-cua-hoc-vien/{id}',
    'admin/study-problems/{id}/edit'                => 'quan-tri/van-de-cua-hoc-vien/{id}/chinh-sua',
    'admin/study-courses'                           => 'quan-tri/khoa-hoc-cho-hoc-vien',
    'admin/study-courses/create'                    => 'quan-tri/khoa-hoc-cho-hoc-vien/them-moi',
    'admin/study-courses/{id}'                      => 'quan-tri/khoa-hoc-cho-hoc-vien/{id}',
    'admin/study-courses/{id}/edit'                 => 'quan-tri/khoa-hoc-cho-hoc-vien/{id}/chinh-sua',
    ...
    'admin/student-agents'                          => 'quan-tri/cong-tac-vien',
    'admin/student-agents/create'                   => 'quan-tri/cong-tac-vien/them-moi',
    'admin/student-agents/{id}'                     => 'quan-tri/cong-tac-vien/{id}',
    'admin/student-agents/{id}/edit'                => 'quan-tri/cong-tac-vien/{id}/chinh-sua',
    'admin/student-agents/{id}/students'            => 'quan-tri/cong-tac-vien/{id}/hoc-vien',
    ...
    'admin/teachers/{id}/review'                    => 'quan-tri/giao-vien/{id}/danh-gia',
