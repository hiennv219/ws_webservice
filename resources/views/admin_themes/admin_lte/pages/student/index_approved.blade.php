...
@section('page_title', trans('pages.admin_approved_students_title'))
@section('page_description', trans('pages.admin_approved_students_desc'))
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('label.status_approved') }}</th>
                                    @if($canDoAction)
