...
@section('page_title', trans('pages.admin_ready_classrooms_title'))
@section('page_description', trans('pages.admin_ready_classrooms_desc'))
@section('page_breadcrumb')
    <ol class="breadcrumb">
        <li><a href="{{ adminUrl() }}"><i class="fa fa-home"></i> {{ trans('pages.admin_dashboard_title') }}</a></li>
        <li><a href="{{ adminUrl('ready-classrooms') }}">{{ trans('pages.admin_ready_classrooms_title') }}</a></li>
    </ol>
@endsection
@section('lib_styles')
